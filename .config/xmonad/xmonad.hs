...
myKeys c =
  ...
  [ ("M-p q", addName "List all dmscripts"     $ spawn "powermenu")
  , ("M-p p", addName "Translate text"         $ spawn "passmenu")]
  ...
  ^++^ subKeys "Scratchpads"
  [ ("M-s 1", addName "Toggle scratchpad terminal"   $ namedScratchpadAction myScratchPads "terminal")
  , ("M-s 2", addName "Toggle scratchpad cmus"       $ namedScratchpadAction myScratchPads "cmus")
  , ("M-s 3", addName "Toggle scratchpad calculator" $ namedScratchpadAction myScratchPads "calculator")]

  -- Controls for mocp music player (SUPER-u followed by a key)
  ^++^ subKeys "Cmus Keys"
  [ ("M-p 1", addName "cmus prev"                $ spawn "cmus-remote --prev")
  , ("M-p 2", addName "cmus play"                $ spawn "cmus-remote --pause")
  , ("M-p 3", addName "cmus next"                $ spawn "cmus-remote --next")
  , ("M-p 4", addName "cmus repeat"                $ spawn "cmus --repeat")
  , ("M-p 5", addName "cmus shuffle"  $ spawn "mocp-remote --shuffle")]
  ...
  [ ("<XF86AudioMute>", addName "Toggle audio mute"   $ spawn "amixer -D pulse set Master toggle")
